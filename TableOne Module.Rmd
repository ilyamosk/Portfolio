...
tableone_stratified <- CreateTableOne(data = data, # the data set
               ...
               strata = "CO_clean") # stratifying variable (exposure of interest)

tableone_stratified <- CreateTableOne(data = glucose.data, # the data set
               vars = c("age", "cursmoke", "cigpday", "sex","educ"), # all variables
               factorVars = c("cursmoke", "cigpday", "sex","educ"), # factors only
               strata = "glucose.cat") # stratifying variable (exposure of interest)
